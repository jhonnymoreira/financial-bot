/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: c711190744903d4ab6d2e1a46d959032)
...
declare namespace Cloudflare {
	...
	interface Env {
		...
		TELEGRAM_WEBHOOK_SECRET_TOKEN: SecretsStoreSecret;
		ALLOWED_USER_IDS: string;
		ALLOWED_CHAT_IDS: string;
		GOOGLE_SERVICE_ACCOUNT_CREDENTIALS: string;
		SPREADSHEET_ID: string;
		SPREADSHEET_BACKLOG_SHEET_NAME: string;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ALLOWED_USER_IDS" | "ALLOWED_CHAT_IDS" | "GOOGLE_SERVICE_ACCOUNT_CREDENTIALS" | "SPREADSHEET_ID" | "SPREADSHEET_BACKLOG_SHEET_NAME">> {}
}
